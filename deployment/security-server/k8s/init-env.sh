...
echo "Forwarding port 4000 for proxy-ui-api and ports 8080 & 8443 for proxy to the host..."
kubectl port-forward service/proxy-ui-api 4000:4000 -n ss & \
kubectl port-forward service/proxy 8080:8080 -n ss & \
kubectl port-forward service/proxy 8443:8443 -n ss & \
wait
