...
#XROAD_REPO_DEB_GPG_KEY_URL="${XROAD_REPO_DEB_GPG_KEY_URL:-}"
#XROAD_REPO_DEB="${XROAD_REPO_DEB:-}"
#XROAD_REPO_RPM_GPG_KEY_URL="${XROAD_REPO_RPM_GPG_KEY_URL:-}"
#XROAD_REPO_RPM="${XROAD_REPO_RPM:-}"
#XROAD_REPO_DEB_DEPENDENCIES="${XROAD_REPO_DEB_DEPENDENCIES:-}"
#XROAD_REPO_RPM_DEPENDENCIES="${XROAD_REPO_RPM_DEPENDENCIES:-}"
