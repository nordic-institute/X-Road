...
- [2 Use Case Model](#use-case-model)
- [2.1 Actors](#actors)
    * [2.2 UC CS\_01: Log In to the Graphical User Interface](#uc-cs_01-log-in-to-the-graphical-user-interface)
    * [2.3 UC CS\_02: Log Out of the Graphical User Interface](#uc-cs_02-log-out-of-the-graphical-user-interface)
    * [2.4 UC CS\_03: Log a User Out of the Graphical User Interface](#uc-cs_03-log-a-user-out-of-the-graphical-user-interface)
    * [2.5 UC CS\_04: Change the Graphical User Interface Language](#uc-cs_04-change-the-graphical-user-interface-language)
    * [2.6 UC CS\_05: View the Installed Software Version](#uc-cs_05-view-the-installed-software-version)
    * [2.7 UC CS\_06: View the List of Configuration Backup Files](#uc-cs_06-view-the-list-of-configuration-backup-files)
    * [2.8 UC CS\_07: Back Up Configuration](#uc-cs_07-back-up-configuration)
    * [2.9 UC CS\_08: Restore Configuration from a Backup File](#uc-cs_08-restore-configuration-from-a-backup-file)
    * [2.10 UC CS\_09: Download a Backup File](#uc-cs_09-download-a-backup-file)
    * [2.11 UC CS\_10: Delete a Backup File](#uc-cs_10-delete-a-backup-file)
    * [2.12 UC CS\_11: Upload a Backup File](#uc-cs_11-upload-a-backup-file)
