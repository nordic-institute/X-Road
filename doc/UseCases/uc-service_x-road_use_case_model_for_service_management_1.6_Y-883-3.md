...
- [3 Use Case Model](#use-case-model)
  * [3.1 Security server](#security-server)
    * [3.1.1 Actors](#actors)
    * [3.1.2 UC SERVICE\_01: View the Service Clients of a Security Server Client](#uc-service_01-view-the-service-clients-of-a-security-server-client)
    * [3.1.3 UC SERVICE\_02: View the Access Rights of a Service Client](#uc-service_02-view-the-access-rights-of-a-service-client)
    * [3.1.4 UC SERVICE\_03: Add a Service Client to a Security Server Client](#uc-service_03-add-a-service-client-to-a-security-server-client)
    * [3.1.5 UC SERVICE\_04: Add Access Rights for a Service Client](#uc-service_04-add-access-rights-for-a-service-client)
    * [3.1.6 UC SERVICE\_05: Remove Access Rights from a Service Client](#uc-service_05-remove-access-rights-from-a-service-client)
    * [3.1.7 UC SERVICE\_06: View the WSDLs of a Security Server Client](#uc-service_06-view-the-wsdls-of-a-security-server-client)
    * [3.1.8 UC SERVICE\_07: View the Services of a Security Server Client](#uc-service_07-view-the-services-of-a-security-server-client)
    * [3.1.9 UC SERVICE\_08: Add a WSDL to a Security Server Client](#uc-service_08-add-a-wsdl-to-a-security-server-client)
    * [3.1.10 UC SERVICE\_09: Edit the Address of a WSDL](#uc-service_09-edit-the-address-of-a-wsdl)
    * [3.1.11 UC SERVICE\_10: Download and Parse WSDL](#uc-service_10-download-and-parse-wsdl)
    * [3.1.12 UC SERVICE\_44: Validate a WSDL](#uc-service_44-validate-a-wsdl)
    * [3.1.13 UC SERVICE\_11: Parse User Input](#uc-service_11-parse-user-input)
    * [3.1.14 UC SERVICE\_12: Enable a WSDL](#uc-service_12-enable-a-wsdl)
    * [3.1.15 UC SERVICE\_13: Disable a WSDL](#uc-service_13-disable-a-wsdl)
    * [3.1.16 UC SERVICE\_14: Refresh a WSDL](#uc-service_14-refresh-a-wsdl)
    * [3.1.17 UC SERVICE\_15: Delete a WSDL](#uc-service_15-delete-a-wsdl)
    * [3.1.18 UC SERVICE\_16: View the Access Rights of a Service](#uc-service_16-view-the-access-rights-of-a-service)
    * [3.1.19 UC SERVICE\_17: Add Access Rights to a Service](#uc-service_17-add-access-rights-to-a-service)
    * [3.1.20 UC SERVICE\_18: Remove Access Rights from a Service](#uc-service_18-remove-access-rights-from-a-service)
    * [3.1.21 UC SERVICE\_19: Edit the Address of a Service](#uc-service_19-edit-the-address-of-a-service)
    * [3.1.22 UC SERVICE\_20: Set the Option to Verify TLS Certificate of a Service](#uc-service_20-set-the-option-to-verify-tls-certificate-of-a-service)
    * [3.1.23 UC SERVICE\_21: Edit the Timeout Value of a Service](#uc-service_21-edit-the-timeout-value-of-a-service)
    * [3.1.24 UC SERVICE\_22: Apply the Parameter Value of a Service to All the Services in the WSDL](#uc-service_22-apply-the-parameter-value-of-a-service-to-all-the-services-in-the-wsdl)
    * [3.1.25 UC SERVICE\_23: View the Local Groups of a Security Server Client](#uc-service_23-view-the-local-groups-of-a-security-server-client)
    * [3.1.26 UC SERVICE\_24: View the Details of a Local Group](#uc-service_24-view-the-details-of-a-local-group)
    * [3.1.27 UC SERVICE\_25: Add a Local Group for a Security Server Client](#uc-service_25-add-a-local-group-for-a-security-server-client)
    * [3.1.28 UC SERVICE\_26: Add Members to a Local Group](#uc-service_26-add-members-to-a-local-group)
    * [3.1.29 UC SERVICE\_27: Remove Members from a Local Group](#uc-service_27-remove-members-from-a-local-group)
    * [3.1.30 UC SERVICE\_28: Edit the Description of a Local Group](#uc-service_28-edit-the-description-of-a-local-group)
    * [3.1.31 UC SERVICE\_29: Delete a Local Group](#uc-service_29-delete-a-local-group)
  * [3.2 Central Server](#central-server)
    * [3.2.1 Actors](#actors-1)
    * [3.2.2 UC SERVICE\_30: View Global Groups](#uc-service_30-view-global-groups)
    * [3.2.3 UC SERVICE\_31: View the Details of a Global Group](#uc-service_31-view-the-details-of-a-global-group)
    * [3.2.4 UC SERVICE\_32: Add a Global Group](#uc-service_32-add-a-global-group)
    * [3.2.5 UC SERVICE\_33: Add Members to a Global Group](#uc-service_33-add-members-to-a-global-group)
    * [3.2.6 UC SERVICE\_34: Remove Members from a Global Group](#uc-service_34-remove-members-from-a-global-group)
    ...
    * [3.2.14 UC SERVICE\_42: Edit the Implementing Service of a Central Service](#uc-service_42-edit-the-implementing-service-of-a-central-service)
    * [3.2.15 UC SERVICE\_43: Delete a Central Service](#uc-service_43-delete-a-central-service)
