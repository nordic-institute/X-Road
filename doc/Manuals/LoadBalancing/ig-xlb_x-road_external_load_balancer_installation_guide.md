...
10. It is highly recommended to use autologin-package with Slaves, because inserting PIN-code is needed for Slave to work at all. Installing and using autologin is guided here: [autologin documentation](https://github.com/vrk-kpa/xroad-utils/tree/master/autologin)
