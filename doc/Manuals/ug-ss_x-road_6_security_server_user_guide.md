...
Example of the `/etc/xroad/conf.d/acme.yml` file contents:
...
acme:
  ...
  # Property is-mac-key-base64-encoded should be true if the provided mac-keys are encoded in base64.
  eab-credentials:
