...
Subsystem can use and provde X-Road services only in "Registered" state. Substystem cannot be used while in "Disabled", "Disabling in progress" or "Enablin in progress" states.
