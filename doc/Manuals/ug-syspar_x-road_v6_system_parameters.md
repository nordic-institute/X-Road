...
| api-base-url                   | https://127.0.0.1:4000/api/v1                       | Central server admin api base URL.                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| api-token                      | <a token with MANAGEMENT_SERVICE role>              | API token for the central server API (required). The token needs to have the MANAGEMENT_SERVICE role (and for security, no other roles).                                                                                                                                                                                                                                                                                                                                                             |
