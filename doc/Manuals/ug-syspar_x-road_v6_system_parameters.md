...
| auto-update-timestamp-service-url                | false                                      | If enabled, makes the security server update timestampinging service URLs when they change in the global configuration |
