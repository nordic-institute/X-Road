...
| 06.04.2018 | 2.31     | Removed TLSv1.1 support with corresponding SHA-1 ciphers. | Kristo Heero |
...
| client-tls-protocols                             | TLSv1.2                            |   |   | TLS protocols (comma-separated list) enabled on the client-side interfaces (for both incoming and outgoing requests) (since version 6.7) |
