...
final class SignatureParameters extends AbstractPartParameters {
    ...
    private SignatureParameters(Map<String, String> parameters,
    ...
    static SignatureParameters of(Map<String, String> headers) {
        if (headers == null) {
        ...
        return new SignatureParameters(headers,
