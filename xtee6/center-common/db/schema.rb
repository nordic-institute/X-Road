...
ActiveRecord::Schema.define(:version => 20150120000000) do
  ...
  add_foreign_key "security_server_clients", "security_server_clients", name: "security_server_clients_sdsb_member_id_fk", column: "sdsb_member_id", dependent: :delete

  add_foreign_key "security_servers", "security_server_clients", name: "security_servers_sdsb_member_id_fk", column: "sdsb_member_id", dependent: :delete
