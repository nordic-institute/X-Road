...
public final class HashChainBuilder {
    ...
    private HashStepType multipartStep(byte[][] inputs, int stepCount) {
    ...
    private static int ceilingLog2(int n) {
        return 32 - numberOfLeadingZeros(n - 1);
    }
