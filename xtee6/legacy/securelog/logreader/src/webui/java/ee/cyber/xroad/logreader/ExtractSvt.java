...
import ee.cyber.xroad.common.SystemProperties;
import ee.cyber.xroad.common.asic.AsicContainer;
import ee.cyber.xroad.common.asic.AsicContainerEntries;
...
public class ExtractSvt extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        try (ServletOutputStream output = response.getOutputStream()) {
            ...
            Date startDate = parseDate(getParameter(request, "startDate"));
            Date endDate = parseDate(getParameter(request, "endDate"));
