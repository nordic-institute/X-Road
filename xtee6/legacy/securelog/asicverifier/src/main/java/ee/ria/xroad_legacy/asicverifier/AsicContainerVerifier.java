package ee.ria.xroad_legacy.asicverifier;
...
import ee.ria.xroad_legacy.common.message.Soap;
import ee.ria.xroad_legacy.common.message.SoapMessageImpl;
import ee.ria.xroad_legacy.common.message.SoapParserImpl;
import ee.ria.xroad_legacy.common.ocsp.OcspVerifier;
import ee.ria.xroad_legacy.common.signature.MessagePart;
import ee.ria.xroad_legacy.common.signature.Signature;
import ee.ria.xroad_legacy.common.signature.SignatureData;
import ee.ria.xroad_legacy.common.signature.SignatureVerifier;
import ee.ria.xroad_legacy.common.signature.TimestampVerifier;
import ee.ria.xroad_legacy.common.util.CryptoUtils;
import ee.ria.xroad_legacy.common.util.XmlUtils;

import static ee.ria.xroad_legacy.common.ErrorCodes.X_MALFORMED_SIGNATURE;
import static ee.ria.xroad_legacy.common.util.MessageFileNames.HASH_CHAIN_RESULT;
import static ee.ria.xroad_legacy.common.util.MessageFileNames.MESSAGE;
