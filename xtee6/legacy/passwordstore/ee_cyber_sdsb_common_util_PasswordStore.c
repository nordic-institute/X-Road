#include "ee_cyber_sdsb_common_util_PasswordStore.h"
...
Java_ee_cyber_sdsb_common_util_PasswordStore_read(JNIEnv *env, jclass jc,
...
Java_ee_cyber_sdsb_common_util_PasswordStore_write(JNIEnv *env, jclass jc,
        jstring j_pathname_for_ftok, jstring j_id,
...
JNIEXPORT void JNICALL
Java_ee_cyber_sdsb_common_util_PasswordStore_clear(JNIEnv *env, jclass jc,
