...
public class OcspClientTest {
    ...
    private static final Map<String, OCSPResp> ocspResponses = new HashMap<>();
    ...
    public void startup() throws Exception {
        ...
        testActor = TestActorRef.create(actorSystem,
    ...
    private void queryAndUpdateCertStatus(OcspClientWorker ocspClient,
            X509Certificate subject) throws Exception {
        OCSPResp response = ocspClient.queryCertStatus(subject);
        String subjectHash = calculateCertHexHash(subject);
        ocspResponses.put(subjectHash, response);
    }

    private OCSPResp getOcspResponse(X509Certificate subject)
            throws Exception {
        return ocspResponses.get(hash(subject));
    }
