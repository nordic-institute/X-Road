...
echo "=====> Run container"
docker run --detach -p $2:4000 -p $httpport:80 -p 5588:5588 --network xroad-network -e XROAD_TOKEN_PIN=$3 -e XROAD_DB_USER=$6 -e XROAD_DB_PASSWD=$7 --name $1 xroad-sidecar-security-server-image
