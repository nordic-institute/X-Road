...
### 1.9 Security Server Sidecar Provider
  ...
  After executing the image we must wait for the xroad-addon-messagelog package to be downloaded and installed (approximately 3-5 minutes), after this wait the new database name "messagelog" will be created.
