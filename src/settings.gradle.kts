...
include("common:common-quarkus-bootstrap")
include("common:globalconf-provider")
...
include("configuration-client:confclient-model")
...
include("security-server:ds:spi:xroad-core-spi")
include("security-server:ds:spi:xroad-messagelog-spi")
include("security-server:ds:extensions:control-plane:xroad-edr")
include("security-server:ds:extensions:control-plane:xroad-policy")
include("security-server:ds:extensions:control-plane:xroad-identity-and-trust")
include("security-server:ds:extensions:data-plane:xroad-data-plane-iam")
include("security-server:ds:extensions:data-plane:xroad-data-plane-public-api")
include("security-server:ds:extensions:data-plane:xroad-messagelog")
include("security-server:ds:extensions:data-plane:xroad-policy")
include("security-server:ds:extensions:identity-hub:xroad-identity-hub-provisioner")
include("security-server:ds:extensions:common:xroad-jsonld")
include("security-server:ds:extensions:common:xroad-jws-signer")
include("security-server:ds:extensions:common:xroad-ldp-verifiable-credentials")
include("security-server:ds:extensions:common:xroad-httpclient")
include("security-server:ds:extensions:common:xroad-webserver")
include("security-server:ds:extensions:common:xroad-spring-bridge")
include("security-server:ds-client")
include("security-server:ds:xroad-ds-security")
include("security-server:ds:runtime:control-plane")
include("security-server:ds:runtime:data-plane")
include("security-server:ds:runtime:identity-hub")
