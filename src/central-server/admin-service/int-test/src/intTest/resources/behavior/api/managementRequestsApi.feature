...
Feature: Management requests API
  ...
  Scenario: Management requests list
    ...
    Then management request list endpoint queried and verified using params
      ...
      | SS       |          |                 |                      |                                                        |                       |       | 5         | 9     | 0            | 11     |                               |
      | SS-3     |          |                 |                      |                                                        |                       |       | 5         | 9     | 0            | 3      |                               |
      | pend     | WAITING  |                 |                      |                                                        |                       |       | 5         | 1     | 1            | 1      |                               |
      | reject   | DECLINED |                 |                      |                                                        |                       |       | 5         | 1     | 1            | 1      |                               |
      |          | APPROVED |                 |                      |                                                        |                       |       | 5         | 1     | 5            | 7      |                               |
      |          | APPROVED |                 |                      |                                                        |                       |       | 5         | 2     | 2            | 7      |                               |
      ...
      | add cert |          |                 |                      | AUTH_CERT_REGISTRATION_REQUEST                         |                       |       |           |       | 5            | 5      |                               |
      | add clie |          |                 |                      | CLIENT_REGISTRATION_REQUEST                            |                       |       | 2         | 1     | 2            | 3      |                               |
      | change   |          |                 |                      | OWNER_CHANGE_REQUEST                                   |                       |       |           |       | 1            | 1      |                               |
