...
Feature: 0450 - CS: Member details view Subsystem tab
  ...
  Scenario: The subsystem can be added by code and the added subsystem immediately appears in the table
    ...
    And Subsystems tab is selected
    When A new subsystem with code: 'e2e-tc2-subsystem' and name: 'TC2 Subsystem' is added
    Then Subsystem with code: 'e2e-tc2-subsystem', name: 'TC2 Subsystem' and status: 'Unregistered' is listed
  ...
  Scenario: The subsystem can be renamed and the change immediately appears in the table
    Given Members tab is selected
    And Member E2E TC2 Member with Subsystems is selected
    And Subsystems tab is selected
    Then Subsystem with code: 'e2e-tc4-subsystem' and status: 'Unregistered' is listed
    When Subsystem with code: 'e2e-tc4-subsystem' is renamed to 'TC4 Subsystem'
    Then Subsystem with code: 'e2e-tc4-subsystem', name: 'TC4 Subsystem' and status: 'Unregistered' is listed
  ...
  Scenario: Can be delete an unregistered subsystem
    ...
    When Subsystem with code: 'e2e-tc3-subsystem' is deleted
    Then Subsystem with code: 'e2e-tc3-subsystem' not listed any more
    When A new subsystem with code: 'e2e-tc3-subsystem' is added
    And Subsystem with code: 'e2e-tc3-subsystem' and status: 'Unregistered' is listed
