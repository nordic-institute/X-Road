  ...
  <div class="pt-10">
    <v-card flat class="xrd-card">
      <v-container>
        ...
        <v-row no-gutters class="mt-10" v-if="hasPermission(permissions.GENERATE_AUTH_CERT_REQ)">
          <v-col
          ><h3>
        ...
        <v-row no-gutters v-if="hasPermission(permissions.GENERATE_AUTH_CERT_REQ)">
          <v-col>
            <table class="xrd-table">
              <thead>
              <tr>
