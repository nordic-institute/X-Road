...
public class CustomLdpPresentationGenerator implements PresentationGenerator<JsonObject> {
    ...
    public CustomLdpPresentationGenerator(PrivateKeyResolver privateKeyResolver, String ownDid,
