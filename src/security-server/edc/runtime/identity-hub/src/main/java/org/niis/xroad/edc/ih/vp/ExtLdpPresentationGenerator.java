...
public class ExtLdpPresentationGenerator extends LdpPresentationGenerator {
    ...
    public ExtLdpPresentationGenerator(PrivateKeyResolver privateKeyResolver,
                                    SignatureSuiteRegistry signatureSuiteRegistry, String defaultSignatureSuite, LdpIssuer ldpIssuer, ObjectMapper mapper) {
        super(privateKeyResolver, signatureSuiteRegistry, defaultSignatureSuite, ldpIssuer, mapper);
