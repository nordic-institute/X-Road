...
INSERT INTO IDENTIFIER(ID, TYPE, XROADINSTANCE, MEMBERCLASS, MEMBERCODE, SUBSYSTEMCODE)
VALUES (1, 'MEMBER', 'FI', 'GOV', 'M1', null);
INSERT INTO IDENTIFIER(ID, TYPE, XROADINSTANCE, MEMBERCLASS, MEMBERCODE, SUBSYSTEMCODE)
VALUES (2, 'SUBSYSTEM', 'FI', 'GOV', 'M1', 'SS1');
INSERT INTO IDENTIFIER(ID, TYPE, XROADINSTANCE, MEMBERCLASS, MEMBERCODE, SUBSYSTEMCODE)
VALUES (3, 'SUBSYSTEM', 'FI', 'GOV', 'M1', 'SS2');
INSERT INTO IDENTIFIER(ID, TYPE, XROADINSTANCE, GROUPCODE)
VALUES (4, 'GLOBALGROUP','FI', 'security-server-owners');
INSERT INTO IDENTIFIER(ID, TYPE, GROUPCODE)
