...
INSERT INTO IDENTIFIER(ID, DISCRIMINATOR, TYPE, XROADINSTANCE, MEMBERCLASS, MEMBERCODE, SUBSYSTEMCODE)
VALUES (1, 'C', 'MEMBER', 'FI', 'GOV', 'M1', null);
INSERT INTO IDENTIFIER(ID, DISCRIMINATOR, TYPE, XROADINSTANCE, MEMBERCLASS, MEMBERCODE, SUBSYSTEMCODE)
VALUES (2, 'C', 'SUBSYSTEM', 'FI', 'GOV', 'M1', 'SS1');
INSERT INTO IDENTIFIER(ID, DISCRIMINATOR, TYPE, XROADINSTANCE, MEMBERCLASS, MEMBERCODE, SUBSYSTEMCODE)
VALUES (3, 'C', 'SUBSYSTEM', 'FI', 'GOV', 'M1', 'SS2');
INSERT INTO IDENTIFIER(ID, DISCRIMINATOR, TYPE, XROADINSTANCE, GROUPCODE)
VALUES (4,'GG','GLOBALGROUP','FI', 'security-server-owners');
INSERT INTO IDENTIFIER(ID, DISCRIMINATOR, TYPE, GROUPCODE)
...
VALUES (14, 'C', 'SUBSYSTEM', 'FI', 'GOV', 'M2', 'SS7');
