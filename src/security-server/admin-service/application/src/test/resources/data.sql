...
-- for example column name CLIENT.ISAUTHENTICATION, not client.isauthentication

INSERT INTO IDENTIFIER(ID, OBJECT_TYPE, XROAD_INSTANCE, MEMBER_CLASS, MEMBER_CODE, SUBSYSTEM_CODE)
VALUES (1, 'MEMBER', 'FI', 'GOV', 'M1', null);
INSERT INTO IDENTIFIER(ID, OBJECT_TYPE, XROAD_INSTANCE, MEMBER_CLASS, MEMBER_CODE, SUBSYSTEM_CODE)
VALUES (2, 'SUBSYSTEM', 'FI', 'GOV', 'M1', 'SS1');
INSERT INTO IDENTIFIER(ID, OBJECT_TYPE, XROAD_INSTANCE, MEMBER_CLASS, MEMBER_CODE, SUBSYSTEM_CODE)
VALUES (3, 'SUBSYSTEM', 'FI', 'GOV', 'M1', 'SS2');
INSERT INTO IDENTIFIER(ID, OBJECT_TYPE, XROAD_INSTANCE, GROUP_CODE)
VALUES (4, 'GLOBALGROUP','FI', 'security-server-owners');
INSERT INTO IDENTIFIER(ID, OBJECT_TYPE, GROUP_CODE)
VALUES (5, 'LOCALGROUP', 'group1');
INSERT INTO IDENTIFIER(ID, OBJECT_TYPE, GROUP_CODE)
VALUES (6, 'LOCALGROUP', 'group2');
INSERT INTO IDENTIFIER(ID, OBJECT_TYPE, XROAD_INSTANCE, MEMBER_CLASS, MEMBER_CODE, SUBSYSTEM_CODE)
VALUES (7, 'SUBSYSTEM', 'FI', 'GOV', 'M2', 'SS5');
INSERT INTO IDENTIFIER(ID, OBJECT_TYPE, XROAD_INSTANCE, MEMBER_CLASS, MEMBER_CODE, SUBSYSTEM_CODE)
VALUES (8, 'SUBSYSTEM', 'FI', 'GOV', 'M2', 'SS6');
INSERT INTO IDENTIFIER(ID, OBJECT_TYPE, XROAD_INSTANCE, GROUP_CODE)
VALUES (9, 'GLOBALGROUP','FI', 'test-globalgroup');
INSERT INTO IDENTIFIER(ID, OBJECT_TYPE, XROAD_INSTANCE, GROUP_CODE)
VALUES (10, 'GLOBALGROUP','FI', 'obsolete-globalgroup');
INSERT INTO IDENTIFIER(ID, OBJECT_TYPE, XROAD_INSTANCE, MEMBER_CLASS, MEMBER_CODE, SUBSYSTEM_CODE)
VALUES (11, 'SUBSYSTEM', 'FI', 'GOV', 'M2', 'OBSOLETE-SUBSYSTEM');
INSERT INTO IDENTIFIER(ID, OBJECT_TYPE, XROAD_INSTANCE, MEMBER_CLASS, MEMBER_CODE, SUBSYSTEM_CODE)
VALUES (12, 'SUBSYSTEM', 'DUMMY', 'PRO', 'M2', 'SS6');
INSERT INTO IDENTIFIER(ID, OBJECT_TYPE, XROAD_INSTANCE, MEMBER_CLASS, MEMBER_CODE, SUBSYSTEM_CODE)
VALUES (13, 'SUBSYSTEM', 'FI', 'DUMMY', 'M2', 'SS6');
INSERT INTO IDENTIFIER(ID, OBJECT_TYPE, XROAD_INSTANCE, MEMBER_CLASS, MEMBER_CODE, SUBSYSTEM_CODE)
VALUES (14, 'SUBSYSTEM', 'FI', 'GOV', 'M2', 'SS7');

-- local clients, comment contains identifier_id, client identifier
-- 1, FI:GOV:M1
INSERT INTO CLIENT(ID, CONF_ID, IDENTIFIER, CLIENTSTATUS, ISAUTHENTICATION)
...
-- 14, FI:GOV:M2:SS6
INSERT INTO CLIENT(ID, CONF_ID, IDENTIFIER, CLIENTSTATUS, ISAUTHENTICATION)
VALUES (8,null,14,'saved', 'SSLNOAUTH');



INSERT INTO LOCALGROUP(ID, GROUPCODE, DESCRIPTION, UPDATED, CLIENT_ID)
...
INSERT INTO SERVERCONF(ID, SERVERCODE, OWNER) VALUES (1, 'TEST-INMEM-SS', 1);

UPDATE CLIENT SET CONF_ID = 1;



INSERT INTO SERVICEDESCRIPTION (ID, CLIENT_ID, URL, DISABLED, DISABLEDNOTICE, REFRESHEDDATE, TYPE)
VALUES (1, 2, 'https://soapservice.com/v1/Endpoint?wsdl', 0, 'Out of order', now(), 'WSDL');
INSERT INTO SERVICEDESCRIPTION (ID, CLIENT_ID, URL, DISABLED, DISABLEDNOTICE, REFRESHEDDATE, TYPE)
VALUES (2, 2, 'https://restservice.com/api/v1', 1, 'Kaputt', now(), 'OPENAPI3');
INSERT INTO SERVICEDESCRIPTION (ID, CLIENT_ID, URL, DISABLED, DISABLEDNOTICE, REFRESHEDDATE, TYPE)
VALUES (3, 3, 'file:src/test/resources/wsdl/testservice.wsdl', 1, 'Do not use!', now(), 'WSDL');
INSERT INTO SERVICEDESCRIPTION (ID, CLIENT_ID, URL, DISABLED, DISABLEDNOTICE, REFRESHEDDATE, TYPE)
VALUES (4, 2, 'https://soapservice.com/v1/no-services?wsdl', 1, 'A WSDL without any services', now(), 'WSDL');
INSERT INTO SERVICEDESCRIPTION (ID, CLIENT_ID, URL, DISABLED, DISABLEDNOTICE, REFRESHEDDATE, TYPE)
VALUES (5, 2, 'https://restservice.com/api/v1/nosuchservice', 1, 'Single test url', now(), 'REST');
INSERT INTO SERVICEDESCRIPTION (ID, CLIENT_ID, URL, DISABLED, DISABLEDNOTICE, REFRESHEDDATE, TYPE)
VALUES (6, 5, 'file:src/test/resources/openapiparser/valid.yaml', 1, 'disabled by default', {ts '2019-05-14 10:46:30.389000'}, 'OPENAPI3');



INSERT INTO SERVICE (ID, SERVICEDESCRIPTION_ID, SERVICECODE, SERVICEVERSION, TITLE, URL, SSLAUTHENTICATION, TIMEOUT)
...
INSERT INTO ENDPOINT (ID, CLIENT_ID, SERVICECODE, METHOD, PATH, GENERATED)
...
INSERT INTO ACCESSRIGHT (ID, SUBJECTID, RIGHTSGIVEN, CLIENT_ID, ENDPOINT_ID)
...
-- test service_client RIGHTSGIVEN_at correct value
...
VALUES ('xroad.proxy-ui-api.client-timeout', '10000', {ts '2026-01-02 12:08:30.000000'}, {ts '2026-01-02 12:08:30.000000'});
