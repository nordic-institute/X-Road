...
Feature: 0300 - Data spaces baseline
  ...
  Scenario: SS0 Identity Hub is provisioned
    Given Identity Hub participant context "test-part-ctx" with DID "did:web:ss0-ds-identity-hub%3A7183" and credential service endpoint "http://ss0-ds-identity-hub:7185/api/credentials/v1/participants/test-part-ctx" is created on "ss0"
  ...
  Scenario: SS1 Identity Hub is provisioned
    Given Identity Hub participant context "test-part-ctx" with DID "did:web:ss1-ds-identity-hub%3A7183" and credential service endpoint "http://ss1-ds-identity-hub:7185/api/credentials/v1/participants/test-part-ctx" is created on "ss1"
