...
Feature: 0920 - SS:Diagnostics - Connection Testing
  ...
  Scenario: Other Security Server connection test can be run
    ...
    Then Other Security Server error message should contain server.clientproxy.proxy.unknown_member

  Scenario: Management Security Server test fails
    When Run test for Management Security Server
    Then Management Security Server error message should contain server.clientproxy.proxy.unknown_member
