...
Feature: 0600 - SS: Backup and Restore
  ...
  Scenario: Configuration can be restored from backup
    ...
    And Client "undefined" with id "DEV:COM:1234:random-sub-1" and status "SAVED" is present in the list
    And Client "undefined" with id "DEV:COM:1234:random-sub-2" and status "SAVED" is missing in the list
    ...
    Then Client "undefined" with id "DEV:COM:1234:random-sub-2" and status "SAVED" is present in the list
    ...
    Then Client "undefined" with id "DEV:COM:1234:random-sub-2" and status "SAVED" is missing in the list
