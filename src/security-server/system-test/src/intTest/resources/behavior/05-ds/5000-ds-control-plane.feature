...
Feature: 5000 - DS control plane tests
  ...
  Scenario: Issuer Service is provisioned
    Given Issuer Service participant context "issuer" with DID "did:web:ds-issuer-service%3A10100:issuer" is initialized and keypair is generated with private key alias "issuer-key"
    And Holder "did:web:ds-identity-hub%3A10100" with DID "did:web:ds-identity-hub%3A10100" is created in issuer service participant "issuer"
  ...
  Scenario: Identity Hub is provisioned
    ...
    When Credential request "xroad-membership-credential-request" for credential definition "xroad-membership-credential-definition" of type "MembershipCredential" from issuer "did:web:ds-issuer-service%3A10100:issuer" is submitted for participant "test-part-ctx"
