...
cp -p %{src}/../../addons/messagelog/scripts/archive-http-transporter.sh %{buildroot}/usr/share/xroad/scripts
cp -p %{src}/../default-configuration/addons/message-log.ini %{buildroot}/etc/xroad/conf.d/addons/
cp -p %{src}/addon/proxy/messagelog-changelog.xml %{buildroot}/usr/share/xroad/db/
