...
ln -s /usr/share/xroad/jlib/postgresql-42.5.3.jar %{buildroot}/usr/share/xroad/jlib/postgresql.jar
...
cp -p %{srcdir}/../../../proxy-ui-api/build/unpacked-libs/postgresql-42.5.3.jar %{buildroot}/usr/share/xroad/jlib/
