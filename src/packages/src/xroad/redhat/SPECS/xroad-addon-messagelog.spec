...
cp -p %{srcdir}/../../../service/message-log-archiver/messagelog-archiver-application/build/libs/messagelog-archiver.jar %{buildroot}/usr/share/xroad/jlib/addon/proxy/
cp -p %{srcdir}/../../../service/message-log-archiver/messagelog-archiver-application/scripts/archive-http-transporter.sh %{buildroot}/usr/share/xroad/scripts
cp -p %{srcdir}/../../../service/message-log-archiver/messagelog-archiver-application/scripts/demo-upload.pl %{buildroot}/usr/share/doc/xroad-addon-messagelog/archive-server/
