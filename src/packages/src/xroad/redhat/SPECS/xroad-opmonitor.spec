...
Requires:           xroad-base = %version-%release, xroad-nginx = %version-%release, xroad-confclient = %version-%release, xroad-signer = %version-%release, postgresql-server, postgresql-contrib
