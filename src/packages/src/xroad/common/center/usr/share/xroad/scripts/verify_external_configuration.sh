...
java ${XROAD_PARAMS} ${XROAD_CONFCLIENT_PARAMS} -cp /usr/share/xroad/jlib/configuration-client.jar  org.niis.xroad.confclient.ConfClientMain --verifyAnchorForExternalSource $@
