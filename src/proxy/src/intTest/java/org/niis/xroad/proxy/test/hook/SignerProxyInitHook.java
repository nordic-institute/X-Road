...
public class SignerProxyInitHook implements BeforeSuiteHook {
    ...
    public void beforeSuite() {
        ...
        System.setProperty("xroad.common.configuration-path", "build/resources/intTest/container-files/etc/xroad/globalconf");
        System.setProperty("xroad.signer.key-configuration-file", "build/resources/intTest/container-files/etc/xroad/signer/keyconf.xml");
