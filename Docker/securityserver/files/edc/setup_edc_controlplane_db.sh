...
crudini --set /etc/xroad-edc/edc-control-plane.properties '' "edc.datasource.default.url" "$url"
crudini --set /etc/xroad-edc/edc-control-plane.properties '' "edc.datasource.default.user" "$user"
crudini --set /etc/xroad-edc/edc-control-plane.properties '' "edc.datasource.default.password" "$password"
