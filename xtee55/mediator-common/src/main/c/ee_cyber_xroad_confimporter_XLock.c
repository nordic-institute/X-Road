#include "ee_cyber_xroad_confimporter_XLock.h"
...
Java_ee_cyber_xroad_confimporter_XLock_init(JNIEnv *env, jobject this,
...
JNIEXPORT void JNICALL
Java_ee_cyber_xroad_confimporter_XLock_readLock(JNIEnv *env, jobject this)
{
    XLock lock;
    int error_code;
...
JNIEXPORT void JNICALL
Java_ee_cyber_xroad_confimporter_XLock_writeLock(JNIEnv *env, jobject this)
{
    XLock lock;
    int error_code;
...
JNIEXPORT void JNICALL
Java_ee_cyber_xroad_confimporter_XLock_unlock(JNIEnv *env, jobject this)
{
    XLock lock;
    int error_code;
