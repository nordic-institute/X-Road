...
import static ee.cyber.xroad.mediator.message.V5XRoadNamespaces.*;
...
public final class V5XRoadDlSoapHeader {
    ...
    /**
     * Contains X-Road 5.0 SOAP message (D/L wrapped) headers for XX namespace.
     */
    @Getter
    @Setter(AccessLevel.PROTECTED)
    @ToString
    @XmlRootElement(name = "Header", namespace = SoapUtils.NS_SOAPENV)
    public static class XX extends AbstractV5XRoadSoapHeader {
    ...
    /**
     * Contains X-Road 5.0 SOAP message (D/L wrapped) headers for EE namespace.
     */
    @Getter
    @Setter(AccessLevel.PROTECTED)
    @ToString
    @XmlRootElement(name = "Header", namespace = SoapUtils.NS_SOAPENV)
    public static class EE extends AbstractV5XRoadSoapHeader {
    ...
    /**
     * Contains X-Road 5.0 SOAP message (D/L wrapped) headers for EU namespace.
     */
    @Getter
    @Setter(AccessLevel.PROTECTED)
    @ToString
    @XmlRootElement(name = "Header", namespace = SoapUtils.NS_SOAPENV)
    public static class EU extends AbstractV5XRoadSoapHeader {
