...
# X-Road repository path that contains the deb files for installation. This will be added to /etc/apt/sources.list.d/xroad.list
XROAD_REPOSITORY_PATH=http://xtee2.asa:8080/xmdev